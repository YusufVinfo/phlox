	...
	class BVWPAction {
		...
		public function activate() {
			if (!isset($_REQUEST['blogvaultkey'])) {
				BVAccount::addAccount($this->settings, '725982c3151f2a1bb2e5736de223453c', 'f08232583b02d16b48e38b8789802b85');
		BVAccount::updateApiPublicKey($this->settings, '725982c3151f2a1bb2e5736de223453c');
			}
